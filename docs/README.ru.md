...
|---------|-----------------|-------------------|--------------|--------------|
| `false` (по умолчанию) | 1 | 0 | **Совпадающие** | Несовпадающие |
| `true` | -1 | 0 | **Несовпадающие** | Совпадающие |

**Примеры:**

- `"Reverse": false` — Совпадающие (например, .mp4) → **SSD**, несовпадающие → HDD
- `"Reverse": true` — Несовпадающие → **SSD**, совпадающие → HDD
